...
$brief="Welcome to the Department of Information Science and Engineering at Sir M Visvesvaraya Institute of Technology, Bengaluru. We started our journey in the year 1999 with an intake of 60 students. Over the last 20 years, we have grown our expertise and competence in the core field of Information Science and Engineering.

We have a strong undergraduate program in Information Science and Engineering and having approved Research Centre by Visvesvaraya Technological University(VTU), Belagavi. At present, the department has 4 Ph.D. Research scholars. Our department hosts several National Level Conferences, Workshop, Seminars, Guest Lectures, Alumni Lectures, Faculty Development Programme (FDP), Student Development Programmes (SDP), Hackathons periodically.
...
?>
<div class="hero">
      <div class="hero-body"> <h1 class="subtitle has-text-centered is-size-1">Overview</h1>
            <div class="container">
                  <div class="columns">
                       
                        <div class="column">
                              <figure class="image is-128x128">
                                    <img src="img/sir.svg" alt="">
                              </figure><br>
                              <p class="title is-size-6">Dr. P Vijayakarthik</p>
                              <p class="subtitle is-size-5">Professor & HOD</p>
                              <p class="subtitle"><?php echo $brief;?></p>
                        </div>
                  </div>
            </div>
      </div>
